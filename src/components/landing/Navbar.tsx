...
export function Navbar() {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <Link
              href="/dashboard"
              className="text-sm font-medium text-white bg-primary hover:bg-primary/90 px-4 py-2 rounded-lg transition-colors flex items-center gap-1.5 shadow-xs"
            >
              Get Started
      ...
      {/* Mobile Drawer */}
      {mobileMenuOpen && (
        <div className="md:hidden bg-card border-b border-border px-4 pt-3 pb-6 space-y-3">
          <a
            href="#features"
          ...
          <div className="pt-3 border-t border-border flex flex-col gap-2.5">
            <Link
              href="/login"
              className="w-full text-center py-2 text-sm font-medium text-muted-foreground hover:text-foreground"
            >
              Log in
            </Link>
            <Link
              href="/dashboard"
              className="w-full text-center py-2.5 text-sm font-medium text-white bg-primary hover:bg-primary/90 rounded-lg"
            >
              Get Started
            </Link>
          </div>
